...
def sanitize():
    ...
    for xml_file in xml_files:
        run_command(f"sed -i 's|github.com/oPSDo/AnyKernel3|github.com/oPSDo/AnyKernel3|g' {xml_file}")
        run_command(f"sed -i 's|github.com/oPSDo/AnyKernel3|github.com/oPSDo/AnyKernel3|g' {xml_file}")
    ...
    if os.path.exists(action_path):
        run_command(f"sed -i 's|https://github.com/oPSDo/AnyKernel3|https://github.com/oPSDo/AnyKernel3|g' {action_path}")
        run_command(f"sed -i 's|https://github.com/oPSDo/AnyKernel3|https://github.com/oPSDo/AnyKernel3|g' {action_path}")
